...
$table_name = $wpdb->prefix . "kushmicronews"; 
	...
	if($onlyNews == "false")
                $output_html .= '<div id="micro-news" class="upcoming-events">';
                $output_html .='<h2>Upcoming Events</h2>';
	...
	{	
		...
		//$formateddate = date('d M Y',$date);
                ...
                $output_html .='<li>';
                $output_html .=' <div class="date-part"> <span class="month">'. $month .'</span><span class="date">'.$day.'</span></div>';
                  // show date part      
		// $output_html .='<div class="date-part"> <span class="month">APR</span> <span class="date">20</span> </div>';

                $output_html .='<div class="news-text">';

                 //show title
	    	//$output_html .='<h3 class="title" style="color:'.$titleColor.'">'.$row->name.'</h3>';
                $output_html .='<a href="#" class="title" style="color:'.$titleColor.'">'.$row->name.'</a>';
	    ...
	    //	$output_html .='<div class="text" style="color:'.$textColor.'">'.$row->text.' ';
	    	...
	    	//$output_html .='</div>';
                $output_html .='<p class="text" style="color:'.$textColor.'">'.$row->text;
	...
	//    $output_html .='</div>';//wrapNews ends
        ...
        $output_html .='</ul>';
        $output_html .='<a href="#" class="read-more"><span>see more</span><i></i></a>';
